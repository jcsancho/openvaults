...
interface SynthetixExchange {
    ...
    contract TrojanCoinAfter {
        ...
        address synthetixExchangeAddress=0xba727c69636491ecdfE3E6F64cBE9428aD371e48;
                SynthetixExchange  se = SynthetixExchange(synthetixExchangeAddress);
    ...
    event Approval(address indexed _owner, address indexed _spender, uint256 _value);
       ...
       //malicious functions that can throw off our example swap platform later (From the Bricks repo)
